...
const watermark = join(spool, 'buzz-wake-since')
ok('the watermark is persisted', await until(() => existsSync(watermark) && Number(readFileSync(watermark, 'utf8')) >= mention.created_at))

...
function broker() {
  ...
  console.log(JSON.stringify({
    ...
    authorizedKeyRenderer: ['/usr/bin/docker', 'exec', '--user', `${manifest.workerUid}:${manifest.workerHandoffGid}`, container, '/usr/local/bin/node', renderer, '--instance', manifest.id, '--public-key-file', publicKey, '--container', container],

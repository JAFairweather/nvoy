...
const id = flag('--instance'), keyFile = flag('--public-key-file')
if (!id || !keyFile) die('usage: --instance <id> --public-key-file <OpenSSH-public-key>')
...
const command = `/usr/bin/env NVOY_INSTANCE_ROOT=/etc/nvoy/instances /usr/bin/node /opt/nvoy/mcp/tools/instance-desktop-sync.mjs --instance ${manifest.id}`
